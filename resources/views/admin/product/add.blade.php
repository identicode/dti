    ...
    <div class="col-lg-12">
	    <div class="ibox float-e-margins">
	        ...
	        <div class="ibox-content">
	            <form class="form-horizontal" method="POST" action="/admin/product">
                    @csrf
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Size Unit</label>
                        <div class="col-sm-5"><input type="text" name="size" class="form-control" required></div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">SRP</label>
                        <div class="col-sm-5"><input type="text" name="srp" class="form-control" required></div>
                    </div>
                    <div class="hr-line-dashed"></div>
